...
public class demo extends JFrame implements ActionListener {
	...
	public demo() {
		...
		lblXWins.setForeground(Color.WHITE);
		...
		lblOWins.setForeground(Color.WHITE);
		...
		lblDraws.setForeground(Color.WHITE);
		...
		lblXWins_1.setForeground(Color.WHITE);
		...
		lblOWins_1.setForeground(Color.WHITE);
		...
		lblDraws_1.setForeground(Color.WHITE);
